            ...
            <div class="card-body">
                ...
                @else
                    @foreach (session('search_results') as $result)
                        <a href="{{ route('course.material.files.view', ['course' => $course->course_id, 'material' => $result->course_material_id, 'file' => $result->file_id]) }}#page={{ $result->page_number }}"
                            ...
                            <div class="border rounded p-3 mb-2">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-12 col-md-4 text-md-end">
                                        <img src="{{ route('course.material.files.thumbnail', ['course' => $course->course_id, 'material' => $result->course_material_id, 'file' => $result->file_id, 'page' => $result->page_number]) }}"
