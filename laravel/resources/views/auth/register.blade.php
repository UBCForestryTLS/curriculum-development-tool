                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-10 offset-md-4">
                                <label for="terms-of-use" class="col-md-14 col-form-label text-md-end">By registering for the website, you agree to the <a href="/terms" target="_blank" rel="noopener noreferrer">Terms of Use</a>.</label>
                            </div>
                        </div>
