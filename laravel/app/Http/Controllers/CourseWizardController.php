...
class CourseWizardController extends Controller
{
    ...
    public function step1($course_id, Request $request)
    {
        ...
        return view('courses.wizard.step1')->with('l_outcomes', $l_outcomes)->with('course', $course)->with('courseDescription', $description)->with('faculties', $faculties)
    ...
    public function step2($course_id, Request $request)
    {
        ...
        return view('courses.wizard.step2')->with('a_methods', $a_methods)->with('course', $course)->with('courseDescription', $description)->with('faculties', $faculties)->with('departments', $departments)->with('campuses', $campuses)
    ...
    public function step3($course_id, Request $request)
    {
        ...
        return view('courses.wizard.step3')->with('l_activities', $l_activities)->with('course', $course)->with('courseDescription', $description)->with('faculties', $faculties)->with('departments', $departments)->with('campuses', $campuses)
    ...
    public function step4($course_id, Request $request)
    {
        ...
        return view('courses.wizard.step4')->with('l_outcomes', $l_outcomes)->with('course', $course)->with('courseDescription', $description)->with('faculties', $faculties)->with('departments', $departments)->with('campuses', $campuses)
    ...
    public function step5(int $course_id, Request $request)
    {
        $isEditor = false;
        if ($request->isEditor) {
            $isEditor = true;
        ...
        $programIds = $coursePrograms->pluck('program_id')->map(fn($id) => $id)->all();
    ...
    public function step6($course_id, Request $request)
    {
        ...
        return view('courses.wizard.step6')->with('l_outcomes', $l_outcomes)->with('course', $course)->with('courseDescription', $description)->with('faculties', $faculties)->with('departments', $departments)->with('campuses', $campuses)
...
public function step9($course_id, Request $request)
{
    $isEditor = false;
    if ($request->isEditor) {
        $isEditor = true;
    ...
    foreach ($l_outcomes as $clo) {
        if (
            (! OutcomeAssessment::where('l_outcome_id', $clo->l_outcome_id)->exists()) ||
            (! OutcomeActivity::where('l_outcome_id', $clo->l_outcome_id)->exists())
        ) {
            $hasNonAlignedCLO = true;
            break;
        }
    ...
    $courseTopics = $course->courseTopics->sortBy('position')->values();
    ...
    return view('courses.wizard.step9')->with('courseTopics', $courseTopics)->with('course', $course)->with('courseDescription', $description)
        ->with('faculties', $faculties)->with('departments', $departments)->with('campuses', $campuses)
        ->with('courseUsers', $courseUsers)->with('user', $user)->with('oAct', $oAct)->with('oAss', $oAss)
        ->with('outcomeMapsCount', $outcomeMapsCount)->with('isEditor', $isEditor)->with('isViewer', $isViewer)
        ->with('standard_categories', $standard_categories)->with('standardsOutcomeMapCount', $standardsOutcomeMapCount)
        ...
        ->with('hasNonAlignedCLO', $hasNonAlignedCLO);
}

public function step10($course_id, Request $request)
{
    $isEditor = false;
    if ($request->isEditor) {
        $isEditor = true;
    ...
    return view('courses.wizard.step10')->with('courseMaterials', $courseMaterials)->with('course', $course)->with('courseDescription', $description)
        ->with('faculties', $faculties)->with('departments', $departments)->with('campuses', $campuses)
        ->with('courseUsers', $courseUsers)->with('user', $user)->with('oAct', $oAct)->with('oAss', $oAss)
        ->with('outcomeMapsCount', $outcomeMapsCount)->with('isEditor', $isEditor)->with('isViewer', $isViewer)
        ->with('standard_categories', $standard_categories)->with('standardsOutcomeMapCount', $standardsOutcomeMapCount)
